...
if(isset($_POST['employee_id']) && isset($_POST['sso_password']))
{
	...
	if(!empty($employee_id ) && !empty($sso_password))
	{
		...
		/*if ($employee_id == "1" && $sso_password == "shikha") {
			echo "Entered!";
			$_SESSION['employee_id'] = $employee_id;
			$_SESSION['employee_id'] = $sso_password;
			header('Location:'. 'index.php');
		}*/
		/*$query = "SELECT * FROM bankers WHERE employee_id='".mysqli_real_escape_string($mysql_connect, $employee_id)."' AND password='".mysqli_real_escape_string($mysql_connect, $password_hash)."'";*/
		// $query = "SELECT employee_id, sso_password FROM bankers WHERE employee_id='".$employee_id."' AND password='".$password_hash."'";
		echo "not empty";
