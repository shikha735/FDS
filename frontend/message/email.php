                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	&nbsp; <br>
                                            	<img src='cid:logo_2u' alt="Chase Fraud logo" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content00">
                                                                ...
                                                                Dear Customer<br><br>
                                                                We detected irregular activity on your credit card. For your protection, you must verify this activity.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content01">
                                                                We will review the activity on your account with you and, upon verification, remove any restrictions
