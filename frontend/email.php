...
<html>
    <head>
        ...
        <meta property="og:title" content="Security Information" />
                                	...
                                	<table border="0" cellpadding="0" cellspacing="0" width="600" id="templateHeader">
                                        <tr>
                                            <td class="headerContent">
                                            	...
                                            	<img src="http://localhost/fds/frontend/img/samples/email.png" style="max-width:600px;" id="headerImage campaign-icon" mc:label="header_image" mc:edit="header_image" mc:allowdesigner mc:allowtext />
                                                    ...
                                                    <tr>
                                                        <td valign="top" class="bodyContent">
                                                            <div mc:edit="std_content01">
                                                                Where <a href="invoice.php" target="_blank">MailChimp</a> can be used to send newsletters to several subscribers in one large blast, <a href="invoice.php" target="_blank">Mandrill</a> is specifically positioned to send transactional emails, and offers relevant tracking and metrics that isn't necessarily available through a traditional email platform.
                                                            </div>
														</td>
                                                    </tr>
                                                    <tr>
                                                            	...
                                                            	<tr>
                                                                	<td valign="middle" class="templateButtonContent">
                                                                    	<div mc:edit="std_content02">
                                                                        	<a href="http://localhost/fds/frontend/invoice.php" target="_blank">Verify</a>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </table>
