...
$query_replies = "SELECT id, subject, body FROM replies";
$result_replies=mysqli_query($mysql_connect, $query_replies);
						...
						<div id="col-left-inner" class="col-left-nano-content">
							...
							<div class="collapse navbar-collapse navbar-ex1-collapse" id="sidebar-nav">
								<ul class="nav nav-pills nav-stacked">
									<li class="nav-header nav-header-first hidden-md hidden-sm hidden-xs">
										Navigation
									</li>
									<li class="active">
										<a href="index.php">
									...
									<div class="col-lg-12">
										...
										<header id="email-header" class="clearfix">
											...
											<div id="email-header-tools">
												<div class="btn-group">
													<button data-toggle="dropdown" class="btn btn-primary dropdown-toggle has-tooltip" type="button" title="Select">
										...
										<div id="email-content" class="email-content-nano">
											<div class="email-content-nano-content">
												<ul id="email-list">
													<?php
													//$i=0;
													while ($row_replies = $result_replies->fetch_row()) 
													{
														$r1=$row_replies[0];
 														$r2=$row_replies[1];
 														$r3=$row_replies[2];
  													?>
													<li class="unread clickable-row" data-href="email-detail.php">
														<div class="chbox">
														...
														<div class="name">
															Cardholder <?php echo $r1; ?>
														</div>
														<div class="message">
															<span class="subject"><?php echo $r2; ?></span>
															<span class="body"><?php echo $r3; ?></span>
														</div>
														<div class="meta-info">
