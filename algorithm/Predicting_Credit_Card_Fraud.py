...
# Tensorflow is used  to build the predictive model, and t-SNE to visualize the dataset in two dimensions at the end of this analysis.
# If you would like to learn more about the data, visit: https://www.kaggle.com/dalpozz/creditcardfraud.
# 
...
import numpy as np  # scientific computing; has n-dimensional data structures
import tensorflow as tf # building and training neural networks
from sklearn.cross_validation import train_test_split
import matplotlib.pyplot as plt, mpld3
from sklearn.utils import shuffle # to shuffle arrays or sparse matrices
from sklearn.metrics import confusion_matrix
import seaborn as sns # visualization library based on matplotlib
import matplotlib.gridspec as gridspec # specifies geometry of the grid that a subplot will be placed
...
f.savefig('../graphs/time_img')
plt.close(f)
print("time_img saved in /graphs folder")
...
plt.ylabel('Number of Transactions')
plt.yscale('log')
f.savefig('../graphs/amount_img')
plt.close(f)
print("amount_img saved in /graphs folder")
# plt.show()
...
plt.xlabel('Time (in Seconds)')
plt.ylabel('Amount')
f.savefig('../graphs/time_amount_img')
plt.close(f)
print("time_amount_img saved in /graphs folder")
# plt.show()
...
# plt.show()
plt.savefig('../graphs/V_histograms')
plt.close(f)
print("image saved in /graphs folder")
...
# We can see that the fraudulent transactions are all part of a group of points.
# This suggests that it is easier for a model to identify the fraudulent transactions in the testing data,
# and to learn about the traits of the fraudulent transactions in the training data.
'''